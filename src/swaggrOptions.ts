const swaggerOptions = {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'API documentation for managing users, brands, and teams in the sales-oriented organization.',
    },
    host: 'localhost:3001',
    basePath: '/api',
    schemes: ['http'],
      ...
      '/createUser': {
        post: {
          ...
          responses: {
            ...
            400: {
              description: 'Bad request (e.g., email already exists, no roles provided)',
            },
          },
        },
      },
