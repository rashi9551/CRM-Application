...
import { IsNotEmpty, IsOptional, IsString, IsEnum, IsDate, IsNumber } from 'class-validator';
...
export class Task {
    ...
    @Column({ name: 'due_date', type: 'timestamp', nullable: false, default: () => 'CURRENT_TIMESTAMP' }) // Task deadline
    dueDate: Date;
